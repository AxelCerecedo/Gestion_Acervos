...
async function inicializarApp() {
  console.log("🚀 Iniciando carga de datos en la app...");

  console.log("⏳ Solicitando repositorios...");
  await cargarRepositorios();
  console.log("✅ Repositorios cargados.");

  console.log("⏳ Solicitando usuarios locales...");
  await cargarUsuarios();
  console.log("✅ Usuarios locales cargados.");

  console.log("⏳ Solicitando registros...");
  await cargarRegistros();
  console.log("✅ Registros cargados.");

  console.log("⏳ Solicitando usuarios de WordPress (esto puede tardar si hay repositorios caídos)...");
  await cargarUsuariosWordPress();
  console.log("✅ Usuarios de WordPress cargados.");

  // Ahora que todos los datos asíncronos están cargados,
  // es seguro llenar los selectores y configurar la aplicación.
  console.log("⚙️ Configurando la interfaz de usuario...");
  ...
  console.log("🎨 Renderizando la tabla y el dashboard...");
  renderUsuarios();
  actualizarDashboard();
          ...
          <form id="formEditarInline">
            ...
            <div class="mb-3">
              ...
              <select class="form-select" id="inlineEditarRol">
                ...
                <option value="ciberseguridad" ${usuario.rol === 'ciberseguridad' ? 'selected':''}>Ciberseguridad (SOC)</option>
              </select>
            </div>
